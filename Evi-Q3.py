...
#'How numerous factors affect the traffic accident severity rating'
...
plt.title('Accident Severity vs Light and factors that affect traffic accident')
plt.ylabel('Accident Severity')
plt.xlabel('Factors')
plt.plot(y_test, preds, color = 'blue')
plt.show()
