...
#'Do the light and weather conditions affect the severity rating in a traffic accident?'
...
df.drop('Number_of_Vehicles', 1, inplace=True)
df.drop('Number_of_Casualties', 1, inplace=True)
...
plt.title('Accident Severity vs Light and weather condition ')
plt.ylabel('Accident Severity')
plt.xlabel('Light and weather condition')
